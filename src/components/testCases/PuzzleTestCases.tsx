...
export interface PuzzleTestCasesRef {
  runAllTests: () => Promise<void>;
}

const PuzzleTestCases = forwardRef<PuzzleTestCasesRef, PuzzleTestCasesProps>(
  ({ testCases, isLoading, code, language, puzzleId }, ref) => {
    const [runningTestIds, setRunningTestIds] = useState<Set<number>>(
      new Set()
    );
...
PuzzleTestCases.displayName = "PuzzleTestCases";
