    ...
    <>
      ...
      >
        ...
        <CollapsibleContent className="mt-2 rounded-xl text-sm">
          <div className="text-muted-foreground rounded-xl border border-muted-foreground/10 shadow-sm bg-muted p-4 [&_code]:bg-muted-foreground/10 [&_p]:mb-2 [&_p:last-child]:mb-0 [&_pre]:bg-muted-foreground/10 [&_pre]:p-2 [&_pre]:rounded-xs [&_pre]:overflow-x-auto [&_ul]:list-disc [&_ul]:ml-4 [&_ol]:list-decimal [&_ol]:ml-4 [&_li]:mb-1">
